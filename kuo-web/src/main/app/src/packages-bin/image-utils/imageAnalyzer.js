...
RequestsCache.prototype = {
    getReqResult: function getReqResult(requestType, imageUrl) {
    ...
    setReqResult: function setReqResult(requestType, imageUrl, result) {
        this[requestType][imageUrl] = this[requestType][imageUrl] || {};
        this[requestType][imageUrl].result = result;
    },
    getReqStatus: function getReqStatus(requestType, imageUrl) {
        var req = this[requestType][imageUrl];
        return req && req.status || null;
    },
    setReqStatus: function setReqStatus(requestType, imageUrl, status) {
        this[requestType][imageUrl] = this[requestType][imageUrl] || {};
        this[requestType][imageUrl].status = status;
    },
    remove: function remove(requestType, imageUrl) {
        delete this[requestType][imageUrl];
    },
    registerCallbacksForResult: function registerCallbacksForResult(requestType, imageUrl, onSuccess, onError) {
        this[requestType][imageUrl] = this[requestType][imageUrl] || {};
        var req = this[requestType][imageUrl];
    ...
    clearResultCallbacks: function clearResultCallbacks(requestType, imageUrl) {
        delete this[requestType][imageUrl].callbacks;
    },
    getResultSuccessCallbacks: function getResultSuccessCallbacks(requestType, imageUrl) {
        var req = this[requestType][imageUrl];
        return req && req.callbacks && req.callbacks.onSuccess || [];
    },
    getResultErrorCallbacks: function getResultErrorCallbacks(requestType, imageUrl) {
        var req = this[requestType][imageUrl];
...
/***** Global Variables *****/
var requestsCache = new RequestsCache(); // eslint-disable-line santa/no-module-state
...
function analyzeImage(imageUrl, imageDimensions, onSuccess, onError) {
    loadImageOntoTempNode(imageUrl, function (imageNode) {
