...
({
  borderTopLeftRadius: leftTop.endsWith('%') ? leftTop : `${leftTop}`,
  borderTopRightRadius: rightTop.endsWith('%') ? rightTop : `${rightTop}`,
  borderBottomLeftRadius: leftBottom.endsWith('%') ? leftBottom : `${leftBottom}`,
  borderBottomRightRadius: rightBottom.endsWith('%') ? rightBottom : `${rightBottom}`,
});
