/*eslint space-in-parens:0, no-extra-parens:0, operator-linebreak:0*/
//******************************************************* SHA256 *******************************************************
/*
...
function rstr2binb(input) {
    ...
    for (let ii = 0; ii < input.length * 8; ii += 8) {
        output[ii >> 5] |= (input.charCodeAt(ii / 8) & 0xFF) << (24 - ii % 32)
    }
    return output
}
...
const sha256_K = [1116352408, 1899447441, -1245643825, -373957723, 961987163, 1508970993,
